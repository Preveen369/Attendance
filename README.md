...
**Attendance App** is an Android-based mobile application designed to manage and track student attendance digitally. Developed using Java, XML, and Firebase, this app demonstrates fundamental Android development practices including user authentication, activity navigation, and list-based data display.

Ideal for beginners and students, this project serves as a starter template for building apps with login/register systems, Firebase-powered backends, and custom user dashboards.
